...
class RoundRepositoryImpl implements RoundRepository {
  ...
  Future<Either<Exception, List<RoundEntity>>> generateRounds({
    ...
    try {
      ...
      return await seasonResult.fold(
        (exception) => Left(exception),
        (seasons) async {
          ...
          final teamStandingsResult = await _seasonTeamRepository.getTeamStandings(
            seasonId: seasonId,
          );
          
          return await teamStandingsResult.fold(
            (exception) => Left(exception),
            (teamStandings) async {
      ...
      return Left(
        Exception('Lỗi khi tạo nhiều vòng đấu: ${e.toString()}'),
      );
    }
  }
  ...
  Future<Either<Exception, RoundEntity>> getRoundById(int id) async {
    try {
      ...
      return Left(
        Exception('Lỗi khi lấy thông tin vòng đấu: ${e.toString()}'),
      );
    }
  }
  ...
  Future<Either<Exception, List<RoundEntity>>> getRounds({
    ...
    try {
      ...
      return Left(
        Exception('Lỗi khi lấy danh sách vòng đấu: ${e.toString()}'),
      );
    }
  }
  ...
  Future<Either<Exception, RoundEntity>> updateRound(RoundEntity round) async {
    try {
      ...
      return Left(
        Exception('Lỗi khi cập nhật vòng đấu: ${e.toString()}'),
      );
    }
  }
}
